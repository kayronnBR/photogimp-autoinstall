...
Primeiro, faça o download do arquivo [PhotoGIMP-linux.tar.gz](https://github.com/kayronnBR/photogimp-autoinstall/raw/refs/heads/main/PhotoGIMP-linux.tar.gz.tar). Após baixar, extraia o conteúdo da pasta.
